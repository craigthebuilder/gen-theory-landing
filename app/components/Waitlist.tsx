...
export default function Waitlist() {
  ...
  return (
    ...
    >
      <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-brand-orange mb-10 md:mb-14 text-center leading-[1.1]">
        Join our community
      </h2>
      <form
        onSubmit={handleSubmit}
        className="w-full max-w-md flex items-center gap-2 border-b border-brand-orange/40 focus-within:border-brand-orange transition-colors duration-300"
        noValidate
      >
        <input
          type="text"
          ...
          className="flex-1 bg-transparent font-sans text-base text-black placeholder:text-black/40 focus:outline-none py-3"
        />
        <button
          type="submit"
